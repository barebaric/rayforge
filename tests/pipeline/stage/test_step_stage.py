...
@patch("rayforge.pipeline.stage.step.get_context")
class TestStepGeneratorStage:
    def test_reconcile_triggers_assembly_if_missing(
        self,
        mock_get_context,
        mock_task_mgr,
        mock_artifact_cache,
        ...
        """
        mock_get_context.return_value.artifact_store.acquire.return_value = (
            True
        )
