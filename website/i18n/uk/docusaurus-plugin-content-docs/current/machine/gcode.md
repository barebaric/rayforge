...
основі G-code (напр. GRBL, Smoothieware, Marlin). Якщо ваша машина
використовує драйвер не на основі G-code (напр. Ruida), ця сторінка
налаштувань повністю прихована.
:::
