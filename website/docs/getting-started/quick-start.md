...
- **Pan**: Middle-click and drag, or hold <kbd>space</kbd> and drag
- **Zoom**: Scroll wheel, or <kbd>ctrl+"+"</kbd> / <kbd>ctrl+"-"</kbd>
...
2. Click **Operations → Add Operation** or press <kbd>ctrl+shift+a</kbd>
...
1. **Save your work**: Use <kbd>ctrl+s</kbd> to save your project frequently
