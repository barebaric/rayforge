...
Siehe den [Installationsleitfaden](../../getting-started/installation.mdx#linux-pixi) für
Pixi-Installationsanweisungen.

### Pre-commit-Hooks (Optional)

Um deinen Code vor jedem Commit automatisch zu formatieren und zu linten, kannst du Pre-commit-Hooks
installieren:
...
Siehe den [Installationsleitfaden](../../getting-started/installation.mdx#windows-developer) für
detaillierte MSYS2-Entwickler-Installationsanweisungen.

### Schnellstart

Entwicklungsaufgaben unter Windows werden über das `run.bat`-Skript verwaltet, das ein Wrapper für
die MSYS2-Shell ist.

Nach dem Klonen des Repositorys und Abschluss der MSYS2-Einrichtung kannst du diese Befehle von
einer Standard-Windows-Eingabeaufforderung oder PowerShell verwenden:
