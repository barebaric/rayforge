...
O parâmetro `context` é uma instância de `RayforgeContext` que dá acesso a tudo no Rayforge. Veja [Acessando Dados do Rayforge](./addon-overview.md#acessando-os-dados-do-rayforge) para detalhes.
