---
description:
  "Erstelle Array-Kopien mit den Modi Gitter, Punktrotation und Kreis. Jeder Modi bietet eine
  Live-Vorschau auf der Leinwand und interaktive Platzierung."
---

# Arrays

Mit der Array-Funktion kannst du mehrere Kopien von ausgewählten Werkstücken in drei verschiedenen
Layout-Modi erstellen. Jeder Modus öffnet einen nicht-modalen Dialog, sodass du weiterhin mit der
Leinwand interagieren kannst, während du die Parameter anpasst — die Vorschau aktualisiert sich in
Echtzeit.
...
Der Gitter-Modus ordnet Kopien in einer rechteckigen Matrix aus Zeilen und Spalten an, mit
konfigurierbarem horizontalen und vertikalem Abstand.
...
| **Abstandsmodus**  | Wähle zwischen _Lücke_ (Abstand zwischen Kopien) oder _Steigung_ (Abstand von Kante zu Kante jedes Exemplars) |
...
Der Punktrotations-Modus erstellt Kopien, indem er sie an ihrem eigenen Mittelpunkt rotiert. Dies
ist nützlich für die Erstellung von kreisförmigen Mustern, bei denen jede Kopie an ihrem Originalort
bleibt, aber um einen Bruchteil des Gesamtwinkels gedreht wird.
...
Der Kreis-Modus platziert Kopien entlang eines Kreisbogens um einen Mittelpunkt. Ein
Fadenkreuz-Marker auf der Leinwand zeigt den Mittelpunkt an, und du kannst ihn an eine neue Position
ziehen, während der Dialog geöffnet ist.
