...
El color usado para mostrar las operaciones de este láser (cortes y grabado) en
el lienzo y la vista previa 3D. Esto te ayuda a distinguir visualmente qué
láser realizará cada operación cuando trabajas con múltiples cabezales láser.
