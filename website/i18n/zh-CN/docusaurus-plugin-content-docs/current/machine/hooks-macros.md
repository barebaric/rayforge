...
:::note 作业级 G 代码作业开始和结束 G 代码通过方言的前导和后缀设置配置，而不是钩子。有关详细信息，请参阅
[G 代码设置](gcode)。:::
...
:::note 图层特定钩子 Rayforge 目前不支持每个图层自定义钩子。要实现这一点，请使用条件 G 代码或单独的机器配置文件。:::

---

## 安全注意事项

:::danger 生产前测试始终在**模拟模式**或激光**禁用**的情况下测试宏和钩子，然后在真实作业上运行。配置错误的 G 代码可能导致：
