...
Для дизайнів з отворами або внутрішніми вирізами ви можете обрати трасування лише найзовнішньої межі:

- **Видалення внутрішніх шляхів**: коли увімкнено, трасується лише найзовнішній контур
- Внутрішні отвори та вирізи ігноруються

Це корисно, коли ви хочете вирізати форму, але зберегти внутрішню частину, наприклад, для створення рамки або контуру без вирізання внутрішніх деталей.
...
:::tip Вхід/Вихід vs Перекриття різу
[Вхід/Вихід](../lead-in-out.md) додає рухи підходу та виходу з нульовою потужністю до та після траєкторії різу. Перекриття різу подовжує саму траєкторію різу за з'єднання. Їх можна використовувати разом для оптимальної якості різу.
:::

#### Повторне трасування з налаштовуваним порогом

Працюючи з растровими зображеннями, конвертованими у вектори, ви можете контролювати, які частини будуть протрасовані:
...
- **[Утримуючі лапки](../holding-tabs.md)** - Утримання вирізаних деталей прикріпленими до матеріалу заготовки
...
- **[Вхід/Вихід](../lead-in-out.md)** - Додати рухи під'їзду та виїзду з нульовою потужністю для чистіших кінців різу
