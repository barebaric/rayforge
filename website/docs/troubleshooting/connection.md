...
See the [Snap Permissions](snap-permissions) guide for more details.
...
Try sending a manual command in the Console:
...
Rayforge includes detailed logging for connection issues. To enable debug logging:
