...
def show_import_dialog(
    ...
    for importer_class in importers:
        ...
        # FIX START: Add support for file patterns (extensions)
        if hasattr(importer_class, 'extensions') and importer_class.extensions:
            for ext in importer_class.extensions:
                # Gtk.FileFilter expects patterns like "*.dxf"
                pattern = f"*{ext}"
