...
TARGETS = {
    ...
    "app-settings:color-rules": "app_settings_color_rules",
    "app-settings:color-rules:add": "color_rule_dialog",
    ...
    "addons:sketcher:parameters:panel": "sketcher_parameters",
    "addons:sketcher:parameters:expression": "sketcher_parameters",
    "addons:sketcher:parameters": "sketcher_parameters",
    ...
    "addons:sketcher:tool:text-box": "sketcher_tools",
    "addons:sketcher:tool:text-box:font-properties": "sketcher_tools",
