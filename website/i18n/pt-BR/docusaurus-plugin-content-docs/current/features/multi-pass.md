...
Multi-passagem repete o caminho de corte ou gravação múltiplas vezes, opcionalmente descendo em Z
entre passagens. Isso é útil para materiais espessos ou criar gravações mais profundas.

## Como Funciona

Cada passagem traça o mesmo caminho novamente. Com o degrau-Z habilitado, o laser se move mais
próximo do material entre passagens, cortando progressivamente mais fundo.
...
Distância para baixar o eixo Z entre passagens (0-50 mm). Só funciona se sua máquina tiver controle
de eixo Z.
...
Múltiplas passagens na mesma profundidade frequentemente cortam mais limpo que uma única passagem
lenta. A primeira passagem cria um kerf, e passagens subsequentes seguem o mesmo caminho mais
eficientemente.

**Gravação profunda:**

Com degrau-Z, você pode esculpir padrões de relevo ou gravações que seriam impossíveis em uma única
passagem.

**Qualidade de borda melhorada:**

Múltiplas passagens mais rápidas frequentemente produzem bordas mais limpas que uma passagem lenta,
especialmente em materiais que carbonizam facilmente.
