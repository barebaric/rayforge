...
1. Open the **Assets** tab in the bottom panel
2. Click **Add Stock** — this button is shown when the asset list is empty
3. A new stock item will be created with default dimensions (80% of your machine's work area), placed with its corner at the machine origin
4. The stock will appear as a rectangle in the workspace

Alternatively, you can add stock by:

- Using the **+** button in the Assets tab and choosing **Add Stock**
- Right-clicking an empty area of the asset list and selecting **New Stock**
- Right-clicking an empty area of the canvas and selecting **New Stock**
- Pressing `Ctrl+Alt+S`

You can also drag a stock asset from the Assets tab onto the canvas to place another stock item.

### Stock Properties

Double-click a stock asset in the Assets tab to open the **Stock Properties** dialog. Each stock item has the following properties:
...
The stock's dimensions are adjusted by selecting the stock in the workspace and dragging its corner handles.

### Managing Stock Items

- **Rename**: Open the Stock Properties dialog (double-click the asset) and edit the name field
...
- **Edit properties**: Double-click the stock asset in the Assets tab
- **Duplicate**: Right-click the stock asset in the Assets tab and select **Duplicate**
- **Delete**: Right-click the stock asset in the Assets tab and select **Delete**, or select the asset and press `Del`

## Assigning Material

Once you have stock defined, you can assign a material to it:

1. Double-click the stock asset in the **Assets** tab to open the Stock Properties dialog
...
1. Right-click on the workpiece in the canvas
...
- Make sure at least one stock item is defined (auto-layout uses the first visible stock item as its boundary)
