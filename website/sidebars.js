module.exports = {
    ...
    },
        {
          ...
          items: [
            ...
            },
            {
              ...
              label: 'Sketcher',
              items: [
                'features/sketcher/index',
                'features/sketcher/geometry',
                'features/sketcher/constraints',
                'features/sketcher/expressions',
                'features/sketcher/tools',
                'features/sketcher/arrays',
                'features/sketcher/import-export',
              ],
            },
            'features/arrays',
  ...
  developerSidebar: [
    ...
    {
      type: 'category',
      label: 'RayGeo API Reference',
      collapsed: true,
      link: {
        type: 'doc',
        id: 'developer/raygeo-api/raygeo',
      },
      items: [
        {
          type: 'autogenerated',
          dirName: 'developer/raygeo-api',
        },
      ],
    },
  ],
