...
请参阅[材料](../application-settings/materials.md)获取外观属性的完整列表
（纹理、粗糙度、金属质感和着色）。
...
对于定义为**可着色**的材料（例如，彩色亚克力），每个材料项目可以独立覆盖
材料的着色颜色：
...
该颜色仅应用于这个材料项目 — 使用相同材料的其他项目保留自己的颜色。
使用颜色行旁边的清除按钮恢复为材料的默认颜色。对于不可着色的材料，
颜色行被禁用，外观来自材料定义。
