...
:::примітка G-code на рівні завдання
G-code початку та кінця завдання налаштовується через налаштування преамбули та постскрипту діалекту, а не через хуки. Дивіться [Налаштування G-code](gcode) для деталей.
:::
