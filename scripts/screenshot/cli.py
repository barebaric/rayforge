...
TARGETS = {
    ...
    "app-settings:machines:wizard:profile": "config_wizard",
    "app-settings:machines:wizard:controller": "config_wizard",
    "app-settings:machines:wizard:connect": "config_wizard",
    "app-settings:machines:wizard:probe": "config_wizard",
    "app-settings:machines:wizard:ai-provider": "config_wizard",
    "app-settings:machines:wizard:ai-lookup": "config_wizard",
    "app-settings:machines:wizard:hardware": "config_wizard",
    "app-settings:machines:wizard:head": "config_wizard",
    "app-settings:machines:wizard:rotary": "config_wizard",
    "app-settings:machines:wizard:camera": "config_wizard",
