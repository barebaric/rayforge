...
Rayforge надає дві потужні функції автоматизації для налаштування вашого робочого процесу:
**Макроси** та **Хуки**. Обидва дозволяють вставляти власний G-code у ваші завдання, але вони
служать різним цілям.

![Налаштування хуків та макросів](/screenshots/machine-settings-hooks-macros.webp)
...
Макроси - це **іменовані, багаторазові скрипти G-code**, які ви можете виконувати вручну в будь-який
час.
...
Хуки - це **автоматичні вставки G-code**, що спрацьовують специфічними подіями під час виконання
завдання.
...
:::примітка G-code на рівні завдання G-code початку та кінця завдання налаштовується через
налаштування преамбули та постскрипту діалекту, а не через хуки. Дивіться
[Налаштування G-code](gcode) для деталей. :::
...
:::примітка Хуки для конкретних шарів Rayforge наразі не підтримує налаштування хуків для кожного
шару окремо. Для цього використовуйте умовний G-code або окремі профілі машин. :::

---

## Міркування безпеки

:::небезпека Тестуйте перед виробництвом Завжди тестуйте макроси та хуки в **режимі симуляції** або
з **вимкненим лазером** перед запуском на реальних завданнях. Неправильно налаштований G-code може:
...
- [Діалекти G-code](../reference/gcode-dialects.md) - Сумісність G-code
- [Загальні налаштування](general) - Конфігурація машини
- [Багатошаровий робочий процес](../features/multi-layer.md) - Використання хуків з шарами
