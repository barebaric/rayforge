...
Le lissage de parcours réduit les bords irréguliers et les transitions brusques dans vos parcours de
coupe, résultant en des courbes plus propres et un mouvement machine plus fluide.

## Comment Ça Fonctionne

Le lissage applique un filtre à votre géométrie de parcours qui arrondit les coins angulaires et
lisse les bords rugueux. Le laser suit une trajectoire plus douce au lieu de faire des changements
de direction abrupts.
...
Contrôle le niveau de lissage du parcours (0-100). Des valeurs plus élevées produisent des courbes
plus arrondies mais peuvent s'écarter davantage du parcours original.
...
Les angles plus aigus que cette valeur sont préservés comme coins plutôt que lissés (0-179 degrés).
Cela empêche les caractéristiques pointues importantes d'être arrondies.
